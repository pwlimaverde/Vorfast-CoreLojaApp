...
import '../institucional/institucional_features/carregar_empresa/external/datasources_impl/firebase_usuario_datasource.dart';
  ...
  void dependencies() {
    Get.put<ConfiguracaoGeralController>(
      ConfiguracaoGeralController(
        //usecases
        carregarTheme: CarregarThemeUsecaseImpl(
          //infra
        ...
        //usecases
        checarConeccao: ChecarConeccaoUsecaseImpl(
          //infra
        ...
        //usecases
        carregarUsuario: CarregarUsuarioUsecaseImpl(
          //infra
        ...
        //usecases
        carregarEmpresa: CarregarEmpresaUsecaseImpl(
          //infra
