...
class HomeController extends GetxController {
  ...
  final _allSecao = List<SecaoModel>().obs;
  get allSecao => this._allSecao;
  List<SecaoModel> get allSecaoValue => this._allSecao;
  ...
  List<Widget> get listSlv {
    ...
    for (SecaoModel secao in allSecaoValue) {
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      widgetCore.EditbuttonCoreWidget(
                        ...
                        onPressedEdit: () {},
                        onPressedcheck: () {
                          saveHeader(doc: secao.reference.documentID);
                        },
                      ),
                    ],
                  ),
  ...
  void getAllSecao() {
    ...
    this.allSecao = repo.getAllSecao();
    this.statusGeralAtual = AppStatus.success;
  }

  void getThemeConfig() {
    this.statusGeralAtual = AppStatus.loading;
    repo.getThemeConfig().then((value) {
      // theme = value;
      primaryRController.text = value.primary["r"].toString();
      primaryGController.text = value.primary["g"].toString();
      primaryBController.text = value.primary["b"].toString();
      primaryREditValido = value.primary["r"];
      primaryGEditValido = value.primary["g"];
      primaryBEditValido = value.primary["b"];

      accentRController.text = value.accent["r"].toString();
      accentGController.text = value.accent["g"].toString();
      accentBController.text = value.accent["b"].toString();
      accentREditValido = value.accent["r"];
      accentGEditValido = value.accent["g"];
      accentBEditValido = value.accent["b"];
    });
    this.statusGeralAtual = AppStatus.success;
  }
